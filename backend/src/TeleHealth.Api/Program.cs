...
builder.Services.AddScoped<AdminGetLabTechHandler>();
...
builder.Services.AddScoped<AdminGetAuditLogsHandler>();
builder.Services.AddScoped<AdminGetDashboardSummaryHandler>();
builder.Services.AddScoped<AdminGetSettingsHandler>();
builder.Services.AddScoped<AdminUpdateSettingsHandler>();
