...
Execute unit tests
```
    cd "AppointmentReminder-dev-SentReminders/test/AppointmentReminder-dev-SentReminders.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AppointmentReminder-dev-SentReminders/src/AppointmentReminder-dev-SentReminders"
