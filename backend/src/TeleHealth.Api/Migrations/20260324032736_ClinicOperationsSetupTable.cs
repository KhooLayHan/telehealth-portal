...
namespace TeleHealth.Api.Migrations
{
    ...
    public partial class ClinicOperationsSetupTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    visit_reason = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: false
                    ),
                    check_in_date_time = table.Column<Instant>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    consultation_date_time = table.Column<Instant>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    created_at = table.Column<Instant>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    s3object_key = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: true
                    ),
                    ...
                    uploaded_at = table.Column<Instant>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    created_at = table.Column<Instant>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    medication_name = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "lab_reports");
            ...
            migrationBuilder.DropTable(name: "doctor_schedules");
