...
namespace TeleHealth.Api.Migrations
{
    ...
    public partial class LookupAndIdentityProfileTable : Migration
    {
        ...
        {
            migrationBuilder.DropIndex(name: "ix_users_slug", table: "users");

            migrationBuilder.DropCheckConstraint(name: "CHK_Users_Dob_NotFuture", table: "users");

            migrationBuilder.DropCheckConstraint(name: "CHK_Users_Gender", table: "users");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    color_code = table.Column<string>(
                        type: "character varying(7)",
                        maxLength: 7,
                        nullable: true
                    ),
                    is_terminal = table.Column<bool>(
                        type: "boolean",
                        nullable: false,
                        defaultValue: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    blood_group = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    license_number = table.Column<string>(
                        type: "character varying(50)",
                        maxLength: 50,
                        nullable: false
                    ),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    {
                        1,
                        "Primary care and general health services",
                        "General Practice",
                        "general",
                    },
                ...
                {
                    {
                        1,
                        "#6B7280",
                        "Waiting for lab technician to upload PDF",
                        "Pending Upload",
                        "pending",
                    },
                    {
                        2,
                        "#F59E0B",
                        "Lambda function is extracting biomarkers",
                        "Processing",
                        "processing",
                    },
                    {
                        3,
                        "#10B981",
                        "Lab report successfully processed and ready",
                        "Completed",
                        "completed",
                    },
                    {
                        4,
                        "#EF4444",
                        "Failed to process or invalid lab report file",
                        "Rejected",
                        "rejected",
                    },
                }
        ...
        {
            migrationBuilder.DropTable(name: "appointment_statuses");

            migrationBuilder.DropTable(name: "doctors");

            migrationBuilder.DropTable(name: "lab_report_statuses");

            migrationBuilder.DropTable(name: "patients");

            migrationBuilder.DropTable(name: "schedule_statuses");

            migrationBuilder.DropTable(name: "departments");

            migrationBuilder.DropIndex(name: "uq_users_email_active", table: "users");

            migrationBuilder.DropIndex(name: "uq_users_ic_active", table: "users");

            migrationBuilder.DropIndex(name: "uq_users_slug_active", table: "users");

            migrationBuilder.DropIndex(name: "uq_users_username_active", table: "users");

            migrationBuilder.DropCheckConstraint(name: "chk_users_dob_not_future", table: "users");
