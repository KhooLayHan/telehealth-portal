...
{
    /// <inheritdoc />
    public partial class FixedAuditLogsPublicIdIssue : Migration
    {
        ...
        {
            // Drop triggers first — can't replace function while triggers depend on it
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    INSERT INTO audit_logs (
                        ...
                        metadata, performed_by_user_id, performed_by_system
                    ) VALUES (
                        uuidv7(),
                        TG_TABLE_NAME,
                        CASE WHEN TG_OP = 'DELETE' THEN OLD.id ELSE NEW.id END,
                        TG_OP,
                        v_old_values, v_new_values, v_changed_cols,
                        v_metadata, v_user_id, v_is_system
                    );
