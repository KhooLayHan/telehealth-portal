...
export const getCreateUrl = () => {
  ...
  return `/api/v1/api/v1/lab-reports/initialize`
}
...
export const getUpdateBySlugUrl = (slug: string,) => {
  ...
  return `/api/v1/api/v1/lab-reports/${slug}/complete`
}
...
export const getGetBySlugUrl = (slug: string,) => {
  ...
  return `/api/v1/api/v1/lab-reports/${slug}/download`
}
...
export const getGetBySlugQueryKey = (slug: string,) => {
    return [
    `/api/v1/api/v1/lab-reports/${slug}/download`
    ] as const;
    }
...
export const getGetAllLabReportsUrl = (params?: GetAllLabReportsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/v1/api/v1/lab-reports?${stringifiedParams}` : `/api/v1/api/v1/lab-reports`
}
...
export const getGetAllLabReportsQueryKey = (params?: GetAllLabReportsParams,) => {
    return [
    `/api/v1/api/v1/lab-reports`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetAllPatientsUrl = (params?: GetAllPatientsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/v1/api/v1/lab-reports/patients?${stringifiedParams}` : `/api/v1/api/v1/lab-reports/patients`
}
...
export const getGetAllPatientsQueryKey = (params?: GetAllPatientsParams,) => {
    return [
    `/api/v1/api/v1/lab-reports/patients`, ...(params ? [params] : [])
    ] as const;
    }
